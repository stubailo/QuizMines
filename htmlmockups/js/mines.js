...
(function() {
  var end_question_time, flag, init_chat, log_messages, move, question_time, render_board, server_url, start_update_clock, update, update_buddy_list, update_view,
    _this = this;
  ...
  update_view = function(data) {
    ...
    return update_buddy_list(data.connected);
  };
  ...
  update_buddy_list = function(buddies) {
    var buddy, entry, _i, _len, _results;
    $("#buddy_list").html("");
    _results = [];
