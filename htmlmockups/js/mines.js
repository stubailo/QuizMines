...
(function() {
  var end_question_time, flag, init_chat, log_messages, move, question_time, render_board, server_url, start_update_clock, update, update_view,
    _this = this;
  ...
  update_view = function(data) {
    ...
    render_board(data);
    return $("#last_update").text(new Date());
  };
  ...
  log_messages = function(messages) {
    ...
    for (_i = 0, _len = messages.length; _i < _len; _i++) {
      message = messages[_i];
      _results.push($("#log_window").append("<p>" + message + "</p>"));
    }
    return _results;
  };
